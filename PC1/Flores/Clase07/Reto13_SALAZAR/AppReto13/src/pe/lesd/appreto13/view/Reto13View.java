 ...
 */
package pe.lesd.appreto13.view;
 ...
 * @author lsalazar
 */
public class Reto13View extends javax.swing.JFrame {

    /**
     * Creates new form Reto13View
     */
    public Reto13View() {
        initComponents();
    }
    ...
    private void btnProcesarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcesarActionPerformed
        ...
        int[] lista = reto13Service.listarNum(tamano);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reto13View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reto13View().setVisible(true);
            }
        });
    }
