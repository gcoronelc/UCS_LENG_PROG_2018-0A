 ...
 */
package pe.zavala.pract_02_zavala_jorge.view;
...
public class Pract02View extends javax.swing.JFrame {
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        cboCategoria.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "PERSONA NATURAL", "PERSONA JURIDICA" }));
  ...
  private void btnProcesarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcesarActionPerformed
    ...
    //proceso
    PrestamoBean prestamoBean = new PrestamoBean("Persona Natural", 1200.0, 6);
    Pract02Service service = new Pract02Service();
    prestamoBean = service.procesarPrestamo(prestamoBean);
  ...
  private void agregarFila(DefaultTableModel tabla, String concepto, double valor) {
